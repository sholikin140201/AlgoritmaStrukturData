...
public class KlasemenMain {
    public static void main(String[] args) {
        ...
        Klasemen[] kls = new Klasemen[namaTim.length];
        for (int i = 0; i < kls.length; i++) {
            kls[i] = new Klasemen(namaTim[i], main[i], selisihGoal[i], poin[i]);
